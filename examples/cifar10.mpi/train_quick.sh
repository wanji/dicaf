...
MV2_ENABLE_AFFINITY=0 MV2_USE_CUDA=1 GLOG_logtostderr=1 mpirun -n 6 $TOOLS/train_net.bin cifar10_quick_solver_lr1.prototxt cifar10_quick_iter_1500.solverstate
